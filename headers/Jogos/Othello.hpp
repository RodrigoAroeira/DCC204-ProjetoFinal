...
public:
     ...
     * 
     * @param leaderboard Referência ao objeto Leaderboard para gerenciamento de pontuações.
     */
     ...
     *
     * Configura as peças iniciais (duas brancas e duas pretas no centro do tabuleiro).
     */
     ...
     * 
     * Sobrescreve o comportamento padrão para associar um tipo de peça ('X' ou 'O') ao jogador.
     *
     * @param jogador Um ponteiro compartilhado para o objeto Jogador a ser registrado.
     * @return true se o jogador foi registrado com sucesso; false se já estava registrado.
     */
     ...
     *
     * Exibe o tabuleiro no terminal, indicando as posições ocupadas e disponíveis.
     */
     ...
     * 
     * Determina se o jogo terminou e calcula o vencedor com base nas condições de vitoria: 
     *caso não haja jogada possível a fazer para ambos os
     *jogadores, vence o jogador com mais peças no tabuleiro. Isso incluí o caso onde um jogador não possui mais peças para jogo.
     *
     ...
     *
     * Determina e retorna as possibilidades de jogadas válidas disponíveis para o jogador atual.
     *
     ...
     *
     * Implementa a lógica para alternar turnos, capturar jogadas e verificar condições de vitória.
     */
    void jogar() override;
